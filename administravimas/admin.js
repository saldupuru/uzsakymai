    ...
    return `<div class="sub-section">
      ...
      <div class="wh-grid">
        <div class="wh-col">
          ...
          <p class="combo-hint" style="margin:-4px 0 10px;">Prie skonio įrašyk turimą likutį (pvz. buteliukų skaičių) - jis automatiškai mažės pagal užsakymus (žr. suvartojimą žemiau). Palikus tuščią, skonis laikomas neribotu.</p>
          <div class="wh-stock-row" style="border-bottom:none;padding-bottom:0;">
          ...
          <p class="combo-hint" style="margin:0 0 10px;">Pakeitus šiuos skaičius (pvz. pasikeitus receptui), naujas kiekis automatiškai naudojamas visiems būsimiems skaičiavimams ir likučių atėmimui.</p>
          <div class="wh-stock-row" style="border-bottom:none;padding-bottom:0;">

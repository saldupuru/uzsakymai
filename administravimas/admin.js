...
// Split out of index.html for performance - see loadScript() call at boot.
  ...
  function pageSectionHtml(){
    ...
    return `<div class="sub-section">
      ...
      ${landingPageCollapsibleHtml('productsIntro', 'Skiltis "Mūsų produktai" - antraštė', productsIntroContent)}
      ${landingPageCollapsibleHtml('productsCakes', 'Produktai: Tortai', productTypeContent('cakes'))}
      ${landingPageCollapsibleHtml('productsJars', 'Produktai: Indeliai', productTypeContent('jars'))}
